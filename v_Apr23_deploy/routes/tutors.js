...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    var appointmentInf = req.body.appointmentInf;
    ...
    var newTutor = {name: name, image: image, appointmentInf: appointmentInf, description: desc, description1: desc1, schedule: schedule, author:author};
...
router.put("/:id", function(req, res){
    var newData = {name: req.body.name, image: req.body.image, appointmentInf: req.body.appointmentInf, description: req.body.description, description1: req.body.description1, schedule: req.body.schedule};
...
router.delete("/:id", function(req, res){
    var newData = {name: req.body.name, image: req.body.image, appointmentInf: req.body.appointmentInf, description: req.body.desc, description1: req.body.desc1};
